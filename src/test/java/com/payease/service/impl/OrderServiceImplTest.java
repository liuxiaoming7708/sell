...
public class OrderServiceImplTest {
    ...
    private final String ORDER_ID = "1511245765412206397";

    @Test
    public void create() throws Exception {

        OrderDTO orderDTO = new OrderDTO();
        orderDTO.setBuyerName("晓明");
        orderDTO.setBuyerAddress("天津滨海新区");
        orderDTO.setBuyerPhone("18920736652");
